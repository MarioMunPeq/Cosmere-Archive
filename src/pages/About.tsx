    ...
    <div className="flex min-h-0 flex-1 items-center justify-center p-6">
      <div className="max-w-lg animate-fade-in-up">
        ...
        <p className="mt-4 leading-relaxed text-gray-400">
          This is an interactive visual encyclopedia of the <strong className="text-gray-300">Cosmere</strong>,
          the shared universe of Brandon Sanderson's fantasy novels.
        </p>
        ...
        <ul className="mt-3 space-y-2 text-sm text-gray-400">
          <li className="flex items-start gap-2">
            <span className="mt-0.5 text-purple-400">✦</span>
            <a href="https://coppermind.net" target="_blank" rel="noopener noreferrer" className="text-purple-400 underline decoration-purple-800 underline-offset-2 hover:text-purple-300">
              The Coppermind
            </a>
          ...
          <li className="flex items-start gap-2">
            <span className="mt-0.5 text-purple-400">✦</span>
            <a href="https://www.brandonsanderson.com" target="_blank" rel="noopener noreferrer" className="text-purple-400 underline decoration-purple-800 underline-offset-2 hover:text-purple-300">
        ...
        <p className="mt-3 text-sm leading-relaxed text-gray-500">
          Built with React 19, TypeScript 6, Vite 8, Tailwind CSS v4, and React Router 7.
          All data is static — no backend or database required.
        </p>

        <div className="mt-8 border-t border-gray-800 pt-6 text-sm text-gray-600">
          <Link to="/" className="text-purple-400 hover:text-purple-300">&larr; Back to the Cosmere Map</Link>
        </div>
      </div>
    </div>
  )
