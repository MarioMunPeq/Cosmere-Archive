...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    numeral: 'III',
    title: 'BOOKS',
    description: 'Collected written records from the Cosmere.',
    annotation: 'Fol. 19–27',
    to: '/books',
  },
  {
    numeral: 'IV',
  ...
  },
  {
    ...
    annotation: 'Fol. 57–62',
    to: '/mind-map',
  },
  {
    numeral: 'IX',
    title: 'LOCATIONS',
    description: 'Planetary and celestial records.',
    annotation: 'Fol. 63–68',
    to: '/locations?tab=shards',
  },
  { numeral: 'X', title: 'STATISTICS', description: 'Archive analysis.', annotation: 'Fol. 69–72', to: '/stats' },
]

const COLS: Chapter[][] = [CHAPTERS.slice(0, 5), CHAPTERS.slice(5, 10)]
