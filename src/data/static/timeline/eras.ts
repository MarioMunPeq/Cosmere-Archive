...
export const ERAS: CosmicEra[] = [
  ...
  },
  {
    ...
    endYear: 999,
    color: "#2d3748",
    description: "Ascension of the Lord Ruler. Millenium of the Final Empire. Development of cultures across the Cosmere.",
  },
  {
    id: "final-empire",
    name: "Final Empire",
    ...
    endYear: 1025,
    color: "#63171b",
    description: "Kelsier's rebellion against the Lord Ruler. The fall of the Final Empire and ascension of Elend Venture.",
  },
  {
    id: "catacendre",
